...
public class AudioBook extends AudioContent {
    ...
    public AudioBook(String title, int year, String id, String type, ArrayList<String> audioFile, int length,
    ...
    public AudioBook(String id, String title, int year, int length, String type, String author, String narrator,
            ArrayList<String> chapterTitles, ArrayList<String> chapters) {
        super(title, year, id, length, type);
        this.author = author;
        this.narrator = narrator;
        this.chapterTitles = chapterTitles;
        this.chapters = chapters;
    ...
    public void play() {
        setAudioFile((ArrayList<String>) List.of("Chapter " + currentChapter + 1 + ". "
