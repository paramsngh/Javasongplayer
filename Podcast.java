...
public class Podcast extends AudioContent {
    ...
    public Podcast(String title, int year, String id, String type, ArrayList<String> audioFile, String host,
            ArrayList<Season> seasons) {
        super(title, year, id, type, audioFile, 0);
        this.host = host;
        if (seasons == null) {
    ...
    public void play() {
        setAudioFile((ArrayList<String>) List.of(seasons.get(currentSeason).episodeTitles.get(currentEpisode) + ".\n"
    ...
    // Two podcasts are equal if they have the same host and their AudioContent
